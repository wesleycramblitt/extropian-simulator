...
echo "=== Build complete ==="
echo "  Demos: ${BUILD_DIR}/extropian-sim-shape-workshop (default)"
echo "         ${BUILD_DIR}/extropian-sim-optimize"
echo "         ${BUILD_DIR}/extropian-sim-turbine-solver"
echo "         ${BUILD_DIR}/extropian-sim-steam-engine"
echo "         ${BUILD_DIR}/extropian-sim-camera-modes"
